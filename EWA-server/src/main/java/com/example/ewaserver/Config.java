...
public class Config implements WebMvcConfigurer , WebSocketConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedMethods("GET", "POST", "PUT", "DELETE").
                allowedOriginPatterns("http://localhost:*", "http://*.hva.nl:*", "wss://*.railway.app/*", "https://*.railway.app/*", "*", getHostIPAddressPattern(), allowedCorsClients)
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(this.announcementDistributor, "/announcements")
                .setAllowedOriginPatterns("http://localhost:*",  "http://*.hva.nl:*", "wss://*.railway.app/*", "https://*.railway.app/*", "*" ,getHostIPAddressPattern(), allowedCorsClients)
        //.withSockJS()
        ;
